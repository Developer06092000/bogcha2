        ...
        {this.state.loader ? (
          ...
          <div>
            ...
            <div className={style.matn}>
              ...
              <h5>JOYFUL</h5>
              <p>
                Flamingo educators talk with and listen to each child, observe
                their nonverbal cues, and engage them in stimulating learning
                activities. Students are exposed to a day that is full of
                joyful, rich, well-rounded experiences that leave each child
                wanting to stay much past their dinnertime when mommy and daddy
